...
/**
 ...
 the sum of A[P] + A[P + 1] + ... + A[Q] divided by the length of the slice. To be precise, the average
 ...
 that, given a non-empty zero-indexed array A consisting of N integers, returns the starting position of the slice with
...
public class MinAvgTwoSlice {
    ...
    private static final String dirPath = System.getProperty("user.dir") + File.separator
            ...
            + File.separator + MinAvgTwoSlice.class.getSimpleName() + File.separator;
